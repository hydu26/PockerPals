...
-- Helper: kiểm tra role từ JWT app_metadata
-- app_metadata được set bởi service_role, user không thể tự sửa
-- role = 'admin'  → super admin (toàn quyền)
-- role = 'leader' → group admin (quản lý nhóm được phân công)
